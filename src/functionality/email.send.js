...
const credentials = {
  ...
  auth: {
    ...
    user: "tara227317@outlook.com",
    pass: "world222"
  },
  tls: {
    serverName: "mail.outlook.com",
  },
  secure: true,
  logger: true,
  debug: true
...
module.exports =  (to, content) => {
  
  // The from and to addresses for the email that is about to be sent.
  const contacts = {
    from: "tara227317@outlook.com",
    to: to,
  ...
  transporter.sendMail(contacts , function (err, data) {
    if(err) {
      console.log(err);
    } else {
      console.log(data);
